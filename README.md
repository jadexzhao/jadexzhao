...
`Python` `TypeScript` `React` `Node.js` `PostgreSQL` `SQL` `D3.js` `Git`

`HIPAA` `WCAG 2.1 AA` `ETL` `real-time systems` `bias detection` `audit trails`
...
[linkedin](https://linkedin.com/in/jadexzhao) · [portfolio](https://matchaxmoxie.github.io/matchaxmoxie) · jlzhao@iu.edu

---

*someday: duck farm. practical and genuinely fun.*
